...
const loginFr = {
  title: 'Bienvenue !',
  dhis2UrlLabel: 'URL DHIS2',
  dhis2UrlTooltip:
    'Entrez le lien DHIS2 sans la dernière barre oblique, par exemple, <code>https://votre-dhis2.com</code> au lieu de <code>https://votre-dhis2.com/</code>.',
  usernameLabel: "Nom d'utilisateur",
  passwordLabel: 'Mot de passe',
  connectButton: 'Se connecter',
  dhis2UrlPlaceholder: 'URL DHIS2',
...
const loginEn = {
  ...
  dhis2UrlTooltip:
    'Enter the DHIS2 Link without the last forward slash, e.g., <code>https://your-dhis2.com</code> instead of <code>https://your-dhis2.com/</code>.',
...
const mainFr = {
  organizationUnits: 'Unités organisationnelles',
  organizationUnitsTooltip:
    'Une unité organisationnelle est généralement une unité géographique qui s’inscrit dans une hiérarchie.',
  ...
  disaggregationTooltip: {
    header: 'La désagrégation comprend :',
    list: [
      '<em>Les options de combinaison de catégories</em> sont composées dynamiquement de toutes les différentes combinaisons d’options qui constituent une combinaison de catégories. Par exemple, deux catégories « Genre » et « Âge » peuvent proposer des options telles que « Masculin » ou « Féminin » et « <5 ans » ou « >5 ans ». Une combinaison pourrait être « Masculin <5 ans ».',
      '<em>Les groupes d’unités organisationnelles</em> sont généralement liés aux attributs des unités organisationnelles, tels que « propriété » et « type ».'
    ]
  },
  download: 'Télécharger',
  downloadNote:
    'Remarque : utilisez un nom de fichier unique pour éviter de remplacer un fichier existant.'
}
...
const deMenuFr = {
  ...
  dataTypeOptions: {
    ...
    programIndicator: 'Indicateur de programme',
